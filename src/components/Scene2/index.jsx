        ...
        <div className="container-scene2">
          ...
          <div className="wrapper-description">
            ...
            <div>
              ...
              유지보수에 참여하여 해당 
              <div className="highlight-container"><span className="highlight">
                프레임워크를 고도화하고 다른 프레임워크와 접목해 사용한 경험
              </span></div>
              이 있습니다.
              <div className="highlight-container"><span className="hightlight">기획부터 개발, 운영</span></div>
              까지 프로젝트 전반적인 과정에 참여하고 경험을 쌓고 있으며, 
              개발 완료로 끝나는 것이 아닌, 
              <div className="highlight-container"><span className="hightlight">지속할 수 있는 개발</span></div>을
              지향합니다.
              <br/>
              <div className="highlight-container"><span className="hightlight">건강한 협업 문화</span></div>를 만드는 일을
              좋아합니다.
              <br/>
